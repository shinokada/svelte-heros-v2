  ...
  >
    ...
    {/if}
      {#if variation === 'outline'}
        <path d="M2.25 7.125C2.25 6.50368 2.75368 6 3.375 6H9.375C9.99632 6 10.5 6.50368 10.5 7.125V10.875C10.5 11.4963 9.99632 12 9.375 12H3.375C2.75368 12 2.25 11.4963 2.25 10.875V7.125Z" stroke="{color}" stroke-width="{strokeWidth}" stroke-linecap="round" stroke-linejoin="round"/> <path d="M14.25 8.625C14.25 8.00368 14.7537 7.5 15.375 7.5H20.625C21.2463 7.5 21.75 8.00368 21.75 8.625V16.875C21.75 17.4963 21.2463 18 20.625 18H15.375C14.7537 18 14.25 17.4963 14.25 16.875V8.625Z" stroke="{color}" stroke-width="{strokeWidth}" stroke-linecap="round" stroke-linejoin="round"/> <path d="M3.75 16.125C3.75 15.5037 4.25368 15 4.875 15H10.125C10.7463 15 11.25 15.5037 11.25 16.125V18.375C11.25 18.9963 10.7463 19.5 10.125 19.5H4.875C4.25368 19.5 3.75 18.9963 3.75 18.375V16.125Z" stroke="{color}" stroke-width="{strokeWidth}" stroke-linecap="round" stroke-linejoin="round"/> 
      ...
      {:else if variation === 'micro'}
        <path d="M1 4C1 3.44772 1.44772 3 2 3H7C7.55228 3 8 3.44772 8 4V7C8 7.55228 7.55228 8 7 8H2C1.44772 8 1 7.55228 1 7V4Z" fill="{color}"/> <path d="M10 5C10 4.44772 10.4477 4 11 4H14C14.5523 4 15 4.44772 15 5V11C15 11.5523 14.5523 12 14 12H11C10.4477 12 10 11.5523 10 11V5Z" fill="{color}"/> <path d="M4 10C3.44772 10 3 10.4477 3 11V12C3 12.5523 3.44772 13 4 13H8C8.55228 13 9 12.5523 9 12V11C9 10.4477 8.55228 10 8 10H4Z" fill="{color}"/> 
      {:else}
