<script context="module">
  const extra: ListType[] = [
    ...
    {
      name: 'Micro',
      icon: ChartLineUpOutline as ComponentType,
      href: '/micro'
    }
  ];
...
<script lang="ts">
  ...
  import { Footer, OnThisPage, extract, Sidebar, removeHyphensAndCapitalize, sidebarList, ExpandOutline, GridPlusOutline, CogOutline, ChartLineUpOutline } from 'runes-webkit'
