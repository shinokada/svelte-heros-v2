...
<p>You can establish global icon preferences in your Svelte application using <Code>setContext</Code>. This allows you to configure icon-related properties once and share them across multiple components. Here's how you can do it.</p>
...
<p>The <Code>size</Code>, <Code>color</Code>, <Code>role</Code>, and other properties are optional, allowing you to fine-tune the appearance and accessibility of your icons as needed.</p>
