...
<HighlightCompo lang="ts" code={modules['./md/stroke-width.md'] as string} />
...
<HighlightCompo lang="ts" code={modules['./md/aria-label.md'] as string} />
...
<HighlightCompo lang="ts" code={modules['./md/dynamically-change-variation.md'] as string} />
